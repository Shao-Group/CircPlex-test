...
The `data` folder contains integrated information from CircPlex experiments. There are two subdirectories `data/testis` and `data/brain` that contain information from the testis and brain sample respectively. The details of the files are as follows:
